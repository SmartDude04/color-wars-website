        ...
        return (
            <div className="h-[260px] rounded-md flex flex-col bg-gray-300 dark:bg-gray-800 items-center justify-center">
                ...
                <div className="flex flex-row">
                    ...
                    <button onClick={() => deleteColor(id)} className="bg-red-700 text-white text-2xl pt-1 pb-1 pl-6 pr-6 rounded-4xl hover:bg-red-800 duration-200 cursor-pointer ml-1">Confirm</button>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="h-[260px] rounded-xl flex flex-col items-center pt-6" style={{
            ...
            <div className="flex flex-row mt-6">
                ...
                <button type="submit" onClick={() => updateColor(id, nameInput, hexColorInput)} className="disabled:bg-gray-500 bg-green-600 dark:bg-green-800 text-white text-2xl pt-1 pb-1 pl-6 pr-6 rounded-4xl not-disabled:hover:bg-green-700 not-disabled:dark:hover:bg-green-900 duration-200 cursor-pointer disabled:cursor-not-allowed ml-1" disabled={!validHex || nameInput.length === 0}>Save</button>
            </div>
        </div>
    );
}